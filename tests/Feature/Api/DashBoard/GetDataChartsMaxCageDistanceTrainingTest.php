...
class GetDataChartsMaxCageDistanceTrainingTest extends TestCase
{
    public function test_get_charts_data_max_cage_distance_ok_range_all(): void
    {
        $date = Carbon::now();
    ...
    public function test_get_charts_data_max_cage_distance_ok_range_one_year(): void
    {
        $date = Carbon::now();
        $user = User::factory()->create([
            'type' => UserTypes::COACH->value
    ...
    public function test_get_charts_data_max_cage_distance_ok_range_six_months(): void
    {
        $date = Carbon::now();
        $user = User::factory()->create([
            'type' => UserTypes::COACH->value
    ...
    public function test_get_charts_data_max_cage_distance_ok_range_three_months(): void
    {
        $date = Carbon::now();
        $user = User::factory()->create([
            'type' => UserTypes::COACH->value
    ...
    public function test_get_charts_data_max_cage_distance_not_found(): void
    {
        $date = Carbon::now();
        $user = User::factory()->create([
            'type' => UserTypes::COACH->value
    ...
    public function test_get_charts_data_max_cage_distance_ok_no_team(): void
    {
        $date = Carbon::now();
        $user = User::factory()->create([
            'type' => UserTypes::COACH->value
    ...
    public function test_get_charts_data_max_cage_distance_not_found_no_team(): void
    {
        $date = Carbon::now();
        $user = User::factory()->create([
            'type' => UserTypes::COACH->value
