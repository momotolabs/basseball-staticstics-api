...
class GetAllSessionByTypeTest extends TestCase
{
    public function test_get_all_trainings_by_type_batting(): void
    {
        ...
        $practice8 = Practice::factory()->create(['type' => PracticeTypes::BATTING, 'team_id' => $team2->id]);
        PracticeLineUp::factory(4)->create([
            'practice_id' => $practice8->id,
            'user_id' => Profile::factory()->create(['user_id' => User::factory()->create()->id])->user_id,
        ]);

        $response = $this->json("GET", 'api/sessions/all/type', [
