...
class EditLongTossResultPractice extends Controller
{
    /**
     * @param Request $request
     * @return JsonResponse
     */
    public function __invoke(LongTossEditRequest $request, $uuid): JsonResponse
    {
        try {
            DB::beginTransaction();

            $model = (new UpdateServiceData(model: new LongTossPractice()))
