...
class EditWeightBallResultPractice extends Controller
{
    /**
     * @param Request $request
     * @return JsonResponse
     */
    public function __invoke(WeightBallEditRequest $request, $uuid): JsonResponse
    {
        try {
            DB::beginTransaction();
            $model = (new UpdateServiceData(model: new WeightBallPractice()))
