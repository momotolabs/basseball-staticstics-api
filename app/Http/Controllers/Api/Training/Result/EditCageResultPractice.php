...
class EditCageResultPractice extends Controller
{
    /**
     * @param Request $request
     * @return JsonResponse
     */
    public function __invoke(CageResultEditRequest $request, $uuid): JsonResponse
    {
        try {
            DB::beginTransaction();
            $model = (new UpdateServiceData(model: new CagePracticeResult()))
