...
class EditExitVelocityResultPractice extends Controller
{
    /**
     * @param Request $request
     * @return JsonResponse
     */
    public function __invoke(ExitVelocityEditRequest $request, $uuid): JsonResponse
    {
        try {
            DB::beginTransaction();

            $model = (new UpdateServiceData(model: new ExitVelocityPractice()))
