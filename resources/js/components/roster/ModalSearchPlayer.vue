    ...
    max-h-[50%] w-[85%] md:w-[100%] ml-3 lg:ml-0">
      <div>
        <div class="flex flex-row w-[100%] items-center mb-5 px-4 ">
          <h1 class="text-lg lg:text-2xl text-baseball-red font-baseball-700 my-5">Choose from existing player</h1>
        ...
        <div class="bg-baseball-gray2 flex flex-row w-[100%] items-center mb-5 py-10 px-[15%]">
